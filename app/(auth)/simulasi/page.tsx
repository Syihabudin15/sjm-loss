    ...
    <div className="flex flex-col lg:flex-row gap-4">
      ...
      >
            ...
            (() => {
              ...
              return (
                <div className="w-full">
                  <div className="mb-2 text-gray-700">Usia Pemohon</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          />
          <div className="w-full">
            <div className="mb-2 text-gray-700">Produk Pembiayaan</div>
            <Select
              className="w-full"
        ...
        {hasAccess("deviasi") && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 bg-yellow-50 p-3 rounded border border-yellow-200">
            <div>
              <div className="mb-1 text-gray-600 text-sm">
                Margin Sumdan (Deviasi)
              </div>
              <Input
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <div>
            <div className="mb-1 text-gray-700">Tenor Pengajuan (Bulan)</div>
            <Input
              value={data.tenor || 0}
              type="number"
              onChange={(e) =>
            ...
            <div className="text-xs text-blue-500 mt-1 flex justify-between">
              ...
              <span className="font-semibold">{data.max_tenor} Bulan</span>
            </div>
          </div>

          <div>
            <div className="mb-1 text-gray-700">Plafond Pengajuan</div>
            <Input
            ...
            />
            <div className="text-xs text-blue-500 mt-1 flex justify-between">
              <span>Maksimal Plafond:</span>
              <span className="font-semibold">
                {IDRFormat(data.max_plafond || 0)}
              </span>
            </div>
          </div>
        </div>
      ...
      >
        <div className="bg-gray-50 border border-gray-200 rounded p-4 mb-4">
          <div className="flex justify-between items-end">
            <div>
              <Text type="secondary">Estimasi Angsuran Per Bulan</Text>
              <Title level={3} style={{ margin: 0, color: "#1890ff" }}>
                {IDRFormat(details.detail.angsuranrounded || 0)}
              </Title>
            </div>
            <div className="text-right text-xs text-gray-500">
              Maks. Angsuran: <br />
              <span className="font-semibold text-gray-700 text-sm">
                {IDRFormat((data.Debitur.salary * data.Sumdan.dsr) / 100 || 0)}
              </span>
            </div>
          </div>
        </div>

        <Divider titlePlacement="left" plain className="text-sm text-gray-500">
        ...
        <div className="flex flex-col gap-2 text-sm text-gray-600 mb-4">
          <div className="flex justify-between items-center py-1 border-b border-gray-100">
            ...
            <span className="font-semibold">
              {IDRFormat(details.administrasi)}
            </span>
          </div>
          <div className="flex justify-between items-center py-1 border-b border-gray-100">
            <span>
              Biaya Asuransi{" "}
              {hasAccess("showpercent") && `(${data.c_insurance}%)`}
            </span>
            {hasAccess("update") ? (
              <Input
                size="small"
              ...
              <span className="font-semibold">
                {IDRFormat(details.asuransi)}
              </span>
            )}
          </div>
          <div className="flex justify-between items-center py-1 border-b border-gray-100">
            <span>Biaya Buka Rekening</span>
            <span className="font-semibold">
          ...
          <div className="flex justify-between items-center py-1 border-b border-gray-100">
            ...
            <span className="font-semibold">{IDRFormat(data.c_gov)}</span>
          </div>
          <div className="flex justify-between items-center py-1 border-b border-gray-100">
          ...
          <div className="flex justify-between items-center py-1 border-b border-gray-100">
            ...
            <span className="font-semibold">{IDRFormat(data.c_mutasi)}</span>
          </div>

          <div className="flex justify-between items-center py-2 mt-2 font-bold text-red-500 bg-red-50 px-2 rounded">
            <span>Total Potongan Biaya</span>
            <span>{IDRFormat(details.biaya)}</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2 text-sm">
          <div className="flex justify-between items-center text-gray-700">
            ...
            <span className="font-semibold">{IDRFormat(details.tk)}</span>
          </div>

          <div className="flex justify-between items-center text-orange-600">
            <span>Nominal Takeover</span>
            <Input
              size="small"
          ...
          <div className="flex justify-between items-center text-orange-600">
            ...
            <span className="font-semibold">
              {IDRFormat(data.c_blokir * details.angsuran || 0)}
            </span>
          </div>

          <div className="flex justify-between items-center py-3 mt-2 font-bold text-lg text-green-600 bg-green-50 px-3 rounded border border-green-200">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs text-gray-500 bg-gray-50 p-3 rounded">
          <div className="flex justify-between">
            <span>NED + Fee:</span>
            <span className="text-gray-700">
              {IDRFormat(details.detail.fee_banpot + data.c_ned)}
            </span>
          </div>
          <div className="flex justify-between">
            <span>Total Angsuran:</span>
            <span className="text-gray-700">{IDRFormat(details.angsuran)}</span>
          </div>
          <div className="flex justify-between">
            <span>Sisa Gaji:</span>
            <span className="text-gray-700">
              {IDRFormat(data.Debitur.salary - details.angsuran)}
            </span>
          </div>
          <div className="flex justify-between">
            <span>DBR:</span>
...
const ModalDetailPembiayaan = ({
  ...
  return (
    <Modal
      ...
      style={{ top: 20 }}
    >
      <div ref={printRef} style={{ padding: "20px", backgroundColor: "#fff" }}>
        <div className="text-center mb-6 border-b-2 border-gray-800 pb-2">
          <p className="font-bold text-xl m-0 tracking-wide">
            RINCIAN SIMULASI PEMBIAYAAN
          </p>
          <p className="text-gray-500 m-0 text-sm">
            Dicetak pada {moment().format("DD MMMM YYYY, HH:mm")}
          </p>
        </div>

        {/* Konten modal dipertahankan logikanya, bisa disesuaikan margin/padding agar lebih rapih saat di-render toPng */}
        <div className="flex gap-4 flex-col sm:flex-row justify-between">
          ...
          <div className="flex-1">
            ...
            >
              ...
              <Descriptions.Item label="Plafond Pengajuan">
                {IDRFormat(data.plafond)}
              </Descriptions.Item>
              <Descriptions.Item label="Tenor">
                {data.tenor} Bulan
              </Descriptions.Item>
              <Descriptions.Item label="Usia/Tanggal Lunas">
                {(() => {
                  const { year, month, day } = GetFullAge(
                    data.Debitur.birthdate,
                    moment(data.created_at).add(data.tenor, "month").toDate(),
                  );
                  return `${year} Thn, ${month} Bln (${moment(data.created_at).add(data.tenor, "month").format("DD/MM/YYYY")})`;
                })()}
              </Descriptions.Item>
            </Descriptions>
          </div>
        ...
        {/* Tabel Analisa Lanjutan & Potongan Biaya (Bisa dipercantik sesuai kebutuhan Print) */}
        {/* ... sisa struktur asli ModalDetailPembiayaan ... */}
      </div>
    </Modal>
  );
};

// ... Interface dan defaultData sama dengan sebelumnya ...
